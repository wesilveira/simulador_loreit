<?php
  ...
  if(isset($_GET["doLogin"]))
  {
    ...
    $buscaLogin = mysqli_query($conexao,"select * from consultores where cpf = '$cpf_login' and password = '$encoded_password'");
...
<body>
    ...
    <header class="header-area">
        <div class="container col-4" style="padding-top: 150px;">
          <div class="divLogin">
          <p class="texto"><strong>Área do Consultor</strong></p>
          <p class="texto1-central">Acompanhe status de propostas geradas e assinaturas concluídas.</p>
          <form id="msform" method="post" action="?doLogin">
            <fieldset>
            <div class="inner" align="left">
                <div class="form-row">
                <div class="form-group col-md-12">
                    <label class="texto1-central" for="txtLogin">Login (CPF Apenas números)</label>

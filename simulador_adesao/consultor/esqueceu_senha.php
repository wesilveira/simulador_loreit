...
<body>
    ...
    <div style="background-color:#ffffff; padding-top: 200px">
      ...
      <br><br><br><p class="texto"><strong>Recuperação de senha</strong></p>
                      <p class="texto1-central">Informe seu cpf, caso exista uma conta para o mesmo, um e-mail será enviado para redefinição da senha.</p>
                      <form id="msform">
                          <fieldset>
                            <div class="inner" align="left">
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                  <label class="texto1-central" for="txtLogin">CPF (Apenas números)</label>

...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="modal" id="loading" style="display:block" id="modal-default">
    ...
    <div id="capture" class="container-full">
        <div class="area-principal" style="margin-top: 0px">
              <div class="bar-left">
                                                      ...
                                                      <div  class="form-card-dep" id="planos2">
                                                        <div style="width:100%;display: flex;">
                                                          ...
                                                          <div style="width:80%">
                                                            ...
                                                            <p class="texto1-left msgIncDep" style="width:100%;margin:0px">Se desejar incluir dependentes, insira a <strong>data de nascimento</strong> e clique em incluir. Você pode incluir até 5 dependentes.</p>
                                                          </div>
                                                        </div>
                                                        ...
                                                        <p class="texto1-central"><strong><span class="qtDep">0</span> </strong>dependente(s).</p>
                                                        <p class="texto1-central"></p>                                    

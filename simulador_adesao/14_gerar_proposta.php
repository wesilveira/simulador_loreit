                                    ...
                                    <!-- <div class="card-header" id="headingOne">
                                      ...
                                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                        <!--<div class="card-body">-->
                                          ...
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">Você finalizou a proposta de plano de saúde. Estamos gerando a proposta final, que será enviada para o e-mail do cliente que você cadastrou.</p>
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">O cliente receberá o link para assinatura, e após a assinatura, ele receberá um token para validação. Caso o cliente tenha dúvidas, oriente-o nesta etapa.</p>
                                          </div>
                                          </center>
                                          <br>
                                          ...
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">3º Depois da confirmação da assinatura, informe-o que os todos os dados serão avaliados e que a operadora de saúde entrará em contato caso a proposta esteja aprovada;</p>
